...
-(id) init{
    ...
    NSString *nibName = iPad ? @"MainViewController_iPad" : @"MainViewController";
...
- (void)performIntroAnimation
{
	...
	[UIView animateWithDuration:0.65f
		...
		{
            if (! iPad){
			self.sImageView.center = CGPointMake(30.0f, 108.0f);
			self.sImageView.transform = CGAffineTransformMakeRotation(-0.22f);
			
			self.nImageView.center = CGPointMake(110.0f, 93.0f);
			self.nImageView.transform = CGAffineTransformMakeRotation(-0.1f);

			self.aImageView.center = CGPointMake(190.0f, 88.0f);

			self.pImageView.center = CGPointMake(270.0f, 93.0f);
			self.pImageView.transform = CGAffineTransformMakeRotation(0.1f);

			self.jokerImageView.center = CGPointMake(350.0f, 108.0f);
			self.jokerImageView.transform = CGAffineTransformMakeRotation(0.22f);
            }
            else{
                self.sImageView.center = CGPointMake(165.0f, 158.0f);
                self.sImageView.transform = CGAffineTransformMakeRotation(-0.22f);
                
                self.nImageView.center = CGPointMake(253.0f, 158.0f);
                self.nImageView.transform = CGAffineTransformMakeRotation(-0.1f);
                
               self.aImageView.center = CGPointMake(341.0f, 158.0f);
                
                self.pImageView.center = CGPointMake(429.0f, 158.0f);
                self.pImageView.transform = CGAffineTransformMakeRotation(0.1f);
                
               self.jokerImageView.center = CGPointMake(517.0f, 158.0f);
                self.jokerImageView.transform = CGAffineTransformMakeRotation(0.22f);
            }
		}
		completion:nil];
