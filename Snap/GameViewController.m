...
- (id)init
{
    ...
    NSString *nibName = iPad ? @"GameViewController_iPad" : @"GameViewController";
...
- (void)showIndicatorForActivePlayer
{
	...
	if (position == PlayerPositionBottom)
		self.centerLabel.text = NSLocalizedString(@"Your turn. Tap the Red Indicator.", @"Status text: your turn");
	else
